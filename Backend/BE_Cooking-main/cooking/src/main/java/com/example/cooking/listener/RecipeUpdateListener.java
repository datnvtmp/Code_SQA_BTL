...
public class RecipeUpdateListener {
    ...
    @EventListener
    public void handleRecipeUpdateEvent(RecipeUpdatedEvent event) {
        try {
            // Tạo payload JSON
            UpdateRecipeRequest newRecipeRequest = event.getUpdateRecipeRequest();
            ...
            outbox.setEventType("RECIPE_UPDATE");
