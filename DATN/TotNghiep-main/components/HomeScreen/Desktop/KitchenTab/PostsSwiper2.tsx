...
const PostsSwiper2 = () => {
    ...
    const {
        ...
        queryKey: [QUERY_KEY.Recipes.GET_LIST_RECICPE + 'like'],
        queryFn: () => ApiHome.getRecipesLike(0, 50), // page = 0, size = 10
        staleTime: 1000 * 60 * 5,
    });
    ...
    return (
        <div className="w-full relative px-4 sm:px-8 md:px-16 mx-auto">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">
                Công thức được nhiều người thích
            </h2>
            <Swiper
